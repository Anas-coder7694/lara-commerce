...
<html>
  <head> 
    ...
    <title>Dark Bootstrap Vendor </title>
    ...
    <link rel="stylesheet" href="{{ asset('vendor_css/style.css') }}">
  ...
  <body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Dark</strong><strong>Vendor</strong></div>
    ...
    <li>
        ...
        <ul id="categoryDropdown" class="collapse list-unstyled">
            ...
            <li><a href="{{route('vendor.viewcategory')}}">View Category</a></li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul id="productDropdown" class="collapse list-unstyled">
            <li><a href="{{ route('vendor.addproduct') }}">Add Product</a></li>
            <li><a href="{{ route('vendor.viewproducts') }}">View Product</a></li>
            <li><a href="{{route('vendor.user.orders')}}">View Order</a></li>
           
        </ul>
    </li>

    <li>
        <a href="#userDropdown" data-toggle="collapse" aria-expanded="false">
            <i class="icon-windows"></i> Users
        </a>
